...
const Home = React.memo(() => {
  ...
  const handleUpload = async () => {
    ...
    let apiEndpoint = 'http://54.220.97.61:8000/api/uploadelectricirl/';
    if (uploadedFile.name === 'SSE2.xlsx') {
      apiEndpoint = 'http://127.0.0.1:8000/api/uploadsse/';
    } else if (uploadedFile.name === 'Energia2.xlsx') {
      apiEndpoint = 'http://127.0.0.1:8000/api/uploadenergia/';
    } else if (uploadedFile.name === 'electric_ie.xlsx') {
      apiEndpoint = 'http://127.0.0.1:8000/api/uploadelectricirl/';
    } else if (uploadedFile.name === 'BG.xlsx') {
      apiEndpoint = 'http://127.0.0.1:8000/api/uploadbordgais/';
    }
    // http://79.125.26.166:8000/api/uploadsse/ 54.220.97.61
    try {
